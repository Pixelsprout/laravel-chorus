...
// Storage key
const getLatestHarmonicIdKey = (userId) =>
  `chorus_latest_harmonic_id_${userId !== null && userId !== void 0 ? userId : "guest"}`;
...
export class ChorusCore {
  ...
  getLatestHarmonicId() {
    ...
    return localStorage.getItem(
      getLatestHarmonicIdKey(
        (_a = this.userId) === null || _a === void 0 ? void 0 : _a.toString(),
      ),
    );
  }
  /**
  ...
  processHarmonics(tableName, harmonics) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (deletes.length) {
          this.log(
            `Batch deleting ${deletes.length} records from ${tableName}`,
          );
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        this.updateTableState(
          tableName,
          Object.assign(Object.assign({}, this.getTableState(tableName)), {
  ...
  initializeTables() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      // Mark as initialized
      this.isInitialized = true;
      this.log("Chorus initialization completed");
    });
  }
  /**
  ...
  updateTableState(tableName, newState) {
    this.tableStates[tableName] = Object.assign(
      Object.assign({}, this.tableStates[tableName]),
      newState,
    );
  }
  /**
