import { type TableWriteActions, type OptimisticCallback } from '@pixelsprout/chorus-core';
/**
...
export declare function useTable<T extends {
    ...
    create: (serverData: Record<string, any>, callback?: ((response: import("@pixelsprout/chorus-core").WriteActionResponse<any>) => void) | undefined) => Promise<import("@pixelsprout/chorus-core").WriteActionResponse<T>>;
    update: (serverData: Record<string, any>, callback?: ((response: import("@pixelsprout/chorus-core").WriteActionResponse<any>) => void) | undefined) => Promise<import("@pixelsprout/chorus-core").WriteActionResponse<T>>;
    remove: (serverData: Record<string, any>, callback?: ((response: import("@pixelsprout/chorus-core").WriteActionResponse<any>) => void) | undefined) => Promise<import("@pixelsprout/chorus-core").WriteActionResponse<T>>;
};
/**
