import { ref as w, watch as P, onMounted as C, onUnmounted as H } from "vue";
...
class m extends T {
   ...
   */
  privateChannel(e) {
    return this.channels["private-" + e] || (this.channels["private-" + e] = new A(
      this.pusher,
      "private-" + e,
      this.options
  ...
  encryptedPrivateChannel(e) {
    return this.channels["private-encrypted-" + e] || (this.channels["private-encrypted-" + e] = new F(
      this.pusher,
      "private-encrypted-" + e,
      this.options
...
class W extends T {
   ...
   */
  channel(e) {
    return this.channels[e] || (this.channels[e] = new x(
      this.socket,
      e,
      this.options
    )), this.channels[e];
...
class N {
  ...
  connectorSupportsEncryptedPrivateChannels(e) {
    return e instanceof m || e instanceof S;
  }
  /**
   * Get the Socket ID for the connection.
   */
...
const Y = () => {
  ...
  return u.Pusher ?? (u.Pusher = B), l = new N(u), l;
}, Z = () => u !== null, ee = (s) => {
  u = {
    ...{
      reverb: {
...
}, y = () => Y(), $ = (s) => Array.isArray(s) ? s : [s], c = {}, z = (s) => {
  if (c[s.id])
  ...
  const i = E(
    ...
    n,
    "private"
  ), r = $(t).map((o) => o.includes(".") ? [o, o.replace(/\./g, "\\")] : [o, o.replace(/\\/g, ".")]).flat(), h = w(!1), p = w(!1), d = (o) => {
    h.value && (r.length === 0 || r.includes(o.type)) && e(o);
  }, b = () => {
    h.value || (p.value || i.channel().notification(d), h.value = !0, p.value = !0);
  }, v = () => {
    h.value && (h.value = !1);
  };
  return C(() => {
